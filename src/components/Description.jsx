...
function Description() {
  return (
    <div className="flex flex-row justify-center m-4 h-[50vwh]">
      ...
      <motion.div
        ...
        whileHover={{ scale: 1 }}
        className="m-4 bg-primary flex font-bold justify-center font-mono text-center flex-col w-full px-8 py-4 relative before:content-[''] before:absolute before:top-0 before:right-0 before:w-1/4 before:h-1/4 before:border-t-2 before:border-r-2 before:border-purple-800 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-1/4 after:h-1/4 after:border-b-2 after:border-l-2 after:border-purple-800"
      >
        <p className="mb-6 ">
